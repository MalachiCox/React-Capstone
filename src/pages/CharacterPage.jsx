...
*/
  ...
  return (
    <>
      <div className="character-body body">
        <Modal open={isOpen} onClose={() => setIsOpen(false)}>
          <div id="quote">{quote}</div>
        </Modal>
        <div className="flex-container">
          <div className="choice-btn-container">
            <button className="choice-btn btn-1" onClick={() => goToAnime()}>
              Anime
            </button>
            <button className="choice-btn  btn-2">Character</button>
          </div>
          <h1 htmlFor="anime">Enter the name of a character to get a quote!</h1>
